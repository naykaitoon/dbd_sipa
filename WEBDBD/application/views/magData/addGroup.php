...
<table class="tableData" width="700" border="0" align="center" cellpadding="5" cellspacing="0">
  ...
  <tbody>
    <tr>
      ...
      <td width="71%" align="left" valign="top" nowrap="nowrap"><input name="detail" type="text" size="70" placeholder="ชื่อกลุ่มที่ต้องการ" required/></td>
    </tr>
     <tr>
      <td align="center" valign="top" nowrap="nowrap">จำนวนประเภทในกลุ่มนี้</td>
      <td width="71%" align="left" valign="top" nowrap="nowrap"><input name="numrow" type="number" required max="999" min="1"  value="1" width="18px" /> 
        &nbsp;ประเภท</td>
    </tr>
  <tr>
